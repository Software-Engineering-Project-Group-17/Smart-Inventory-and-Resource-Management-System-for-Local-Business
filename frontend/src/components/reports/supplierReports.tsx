...
export default function SupplierReportsPage() {
  ...
  const supplierStats = useMemo(() => {
    ...
    filteredRows.forEach((row) => {
      if (row.supplier_name) uniqueSuppliers.add(String(row.supplier_name));
      const value = parseFloat(String(row.total_value || 0));
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          {Object.entries(SUPPLIER_REPORTS).map(([key, config]) => {
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  {rows.length === 0
                    ...
                    : "No supplier data matches your search criteria."}
                </p>
              </div>
            ) : (
