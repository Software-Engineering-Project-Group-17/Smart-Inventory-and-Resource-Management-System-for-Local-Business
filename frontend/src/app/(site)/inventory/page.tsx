      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  LKR {inventory.reduce((sum, item) => sum + (item.sellingPrice * item.quantity), 0).toLocaleString()}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative">
              <button
                onClick={() => setShowExpiryFilterDropdown(!showExpiryFilterDropdown)}
                className="px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#3674B5] focus:border-transparent flex items-center justify-between min-w-[150px]"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  >
                    <span className={newItem.category ? 'text-gray-900' : 'text-gray-400'}>
                      ...
                      <div className="max-h-60 overflow-y-auto">
                        {categories.map(cat => (
                          <button
                            key={cat.id}
                            onClick={() => {
                              setNewItem(prev => ({...prev, category: cat.name}));
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#3674B5] focus:border-transparent text-left flex items-center justify-between"
                  >
                    <span className={newItem.unit ? 'text-gray-900' : 'text-gray-400'}>
                      ...
                      <div className="max-h-60 overflow-y-auto">
                        {units.map(unit => (
                          <button
                            key={unit.id}
                            onClick={() => {
                              setNewItem(prev => ({...prev, unit: unit.name}));
                    ...
                    <td className="px-6 py-4">
                      {editingId === item.id ? (
                        <input
                          ...
                          onChange={(e) => setEditingItem(prev => prev ? {...prev, sellingPrice: parseFloat(e.target.value) || 0} : null)}
                          className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#3674B5] focus:border-transparent"
                        />
                      ) : (
